This is a revised Chrome favorites webscrapper using junit testing, hibernate, and maven. The code designed to be configurable via the parameters table and each class excluding main to be as independent of each as possible. Some of the configuration allows for changing user_agent, scrap timeout, email configuration, and json file source while the program is still operational.
